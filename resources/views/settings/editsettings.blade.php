        ...
        @endif
            <div class="col-sm-9" style="background:white;margin-left:10%;padding-right: 25px;padding-left: 25px;box-shadow: 3px 2px 8px 0px black;">
                <div class="row justify-content-center">
                    <h5 class="pull-right" style="color:mediumseagreen">&nbsp;&nbsp;&nbsp;&nbsp; Update General School Settings</h5>
                    <hr>
                    <br><br><br>
                    <form class="form" action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-10">
                                <div class="input-group add-on input-group-sm">
                                    ...
                                    <input value="{{$editschoolsettings->school_name}}" class="form-control input-sm" placeholder="School Name" name="school_name" type="text" required>
                                </div>
                            </div>
                        </div>
                        <br><br><br>
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                <div class="input-group add-on input-group-sm">
                                    <span>
                                        <img src="/logo/{{$editschoolsettings->school_logo}}" height="50" width="50" alt="">
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-10">
                                <div class="input-group add-on input-group-sm">
                                    ...
                                    <input value="{{$editschoolsettings->school_motto}}" class="form-control input-sm" placeholder="School Motto" name="school_motto" type="text" required>
                                </div>
                            </div>
                        </div>
                        <br><br><br>
                        <div class="form-row">
                            <div class="col-md-10">
                                <div class="input-group add-on input-group-sm">
                                    ...
                                    <input value="{{$editschoolsettings->school_address}}" class="form-control input-sm" placeholder="School Address" name="school_address" type="text" required>
                                </div>
                            </div>
                        </div>
                        <br><br><br>
                        <div class="form-row">
                            <div class="col-md-10">
                                <div class="input-group add-on input-group-sm">
                                    ...
                                    <input value="{{$editschoolsettings->school_email}}" class="form-control input-sm" placeholder="School Email" name="school_email" type="email" required>
                                </div>
                            </div>
                        </div>
                        <br><br><br>
                        <div class="form-row">
                            <div class="col-md-10">
                                <div class="input-group add-on input-group-sm">
                                    ...
                                    <input value="{{$editschoolsettings->school_website}}" class="form-control input-sm" placeholder="School Website" name="school_website" type="text" required>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <a href="{{route('viewsettings',$editschoolsettings->id)}}" class="btn btn-info btn-sm"><i class="fa fa-angle-double-left"></i> Back</a>
