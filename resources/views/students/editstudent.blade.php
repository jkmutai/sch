@extends('templates.master')
    @section('pageheader')
        <span style="font-size: 18px;color: maroon;margin-left: 5%;font-weight: bolder;"><i class="fa fa-user-circle-o"></i> Update Student Registration Details</span>
    ...
    @section('bodycontent')
        ...
        <div class="col-sm-11" style="margin-left:4%;background:white;padding-right: 25px;padding-left: 25px;box-shadow: 3px 2px 8px 0px black;">
                <h4 style="border-bottom: 1px solid menu;"><i class="fa fa-user-md"></i> <span style="color:red;">{{$editstudents->adm}}</span> - <span style="color:green;">{{$editstudents->name}}</span> : Update Details</h4>
                <form class="form-inline" action="{{route('updatestudent',$editstudents->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <div class="row">
                            <label class="col-sm-1 " style="text-align: center" for="adm">Admission Number: </label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control input-sm" name="adm" value="{{$editstudents->adm}}" placeholder="Admission Number" autocomplete="off">
                                @if($errors->has('adm'))
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control input-sm" name="name" value="{{$editstudents->name}}" placeholder="Student Name" autocomplete="off">
                                @if($errors->has('name'))
                            ...
                            <div class="col-sm-2">
                                <select class="form-control input-sm" name="class" autocomplete="off">
                                    <option value="">-- Select Class --</option>
                                    @foreach($classes as $class)
                                        <option value="{{$class->class}}" {{ old('class', $editstudents->class) == $editstudents->class ? 'selected' : '' }}>{{$class->class}}</option>
                                    @endforeach
                                </select>
                                @if($errors->has('class'))
                            ...
                            <div class="col-sm-2">
                                <select class="form-control input-sm" name="stream" autocomplete="off">
                                    <option value="">-- Select Stream --</option>
                                    @foreach($streams as $stream)
                                        <option value="{{$stream->stream}}" {{ old('stream', $editstudents->stream) == $editstudents->stream ? 'selected' : '' }}>{{$stream->stream}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control input-sm" name="house" autocomplete="off">
                                    <option value="">-- Select House --</option>
                                    @foreach($houses as $house)
                                        <option value="{{$house->house}}" {{ old('house', $house->house) == $house->house ? 'selected' : '' }}>{{$house->house}}</option>
                                    @endforeach
                                </select>
                                @if($errors->has('house'))
                            ...
                            <div class="col-sm-2">
                                <input type="date" class="form-control input-sm" name="dob" value="{{$editstudents->dob}}" placeholder="Date of Birth" autocomplete="off">
                                @if($errors->has('dob'))
                            ...
                            <div class="col-sm-2">
                                <select class="form-control input-sm" name="gender" value="{{$editstudents->gender}}" autocomplete="off">
                                    <option value="">-- Select Gender --</option>
                                    <option value="Male" {{ old('gender', $editstudents->gender) == 'Male' ? 'selected' : '' }}>Male</option>
                                    <option value="Female" {{ old('gender', $editstudents->gender) == 'Female' ? 'selected' : '' }}>Female</option>
                                </select>
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control input-sm" name="old_school" value="{{$editstudents->old_school}}" placeholder="Old School" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <input type="date" class="form-control input-sm" name="adm_date" value="{{$editstudents->adm_date}}" placeholder="Admission Date" autocomplete="off">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control input-sm" name="adm_type" autocomplete="off">
                                    <option value="">-- Select adm.type --</option>
                                    <option value="Boarder" {{ old('adm_type', $editstudents->adm_type) == 'Boarder' ? 'selected' : '' }}>Boarder</option>
                                    <option value="Day Scholar" {{ old('adm_type', $editstudents->adm_type) == 'Day Scholar' ? 'selected' : '' }}>Day Scholar</option>
                                </select>
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control input-sm" name="entry_grade" value="{{$editstudents->entry_grade}}" placeholder="Entry Grade" autocomplete="off">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control input-sm" name="special_needs" value="{{$editstudents->special_needs}}" placeholder="Special Needs" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <span class="pull-right">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<img src="/photos/{{$editstudents->photo}}" width="90" height="90" alt="">
                                </span>
                                <input type="file" class="form-control input-sm" name="photo" value="{{$editstudents->photo}}" placeholder="photo" autocomplete="off">
                                @if($errors->has('photo'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control input-sm" name="parent_name" value="{{$editstudents->parent_name}}" placeholder="Parent Name" autocomplete="off">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control input-sm" name="parent_phone" value="{{$editstudents->parent_phone}}" placeholder="Phone" autocomplete="off">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control input-sm" name="parent_address" value="{{$editstudents->parent_address}}" placeholder="Address" autocomplete="off">
                            ...
                            <div class="col-sm-2">
                                <input type="email" class="form-control input-sm" name="parent_email" value="{{$editstudents->parent_email}}" placeholder="Email" autocomplete="off">
                        ...
                        <hr>
                       <button class="btn btn-primary btn-sm" type="submit">Update Student</button>
                        <br><br><br>
                    </div>
                </form>
            </div>
